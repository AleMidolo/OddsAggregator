...
from odds_aggregator.domain import (
    OddsQuote,
    SourceEntityMapping,
    SourceEntityType,
...
def test_quote_replay_is_idempotent_and_distinct_change_is_append_only(
    session: Session,
) -> None:
    ...
    changed_key = build_observation_key(
        bookmaker_id=bookmaker_id,
        selection_id=selection_id,
