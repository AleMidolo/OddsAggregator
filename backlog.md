...
|---|---|---|---|---|
| P0 | #14 Define cross-source prematch matching and canonicalization contract | SOFTWARE ARCHITECT | M1/M2 foundation complete | READY |
...
| P0 | #16 Implement competition/participant/event prematch matching foundation | BACKEND / DATA ENGINEER | #14 | BLOCKED |
| P1 | #17 Implement canonical prematch market/selection matching | BACKEND / DATA ENGINEER | #14, #16; #15 fixtures for real-source acceptance | BLOCKED |
| P1 | #18 Validate multi-source prematch reconciliation end to end | QA / RELEASE ENGINEER | #14, #15, #16, #17 | BLOCKED |
...
1. **SOFTWARE ARCHITECT -> #14** to make prematch matching semantics implementation-ready and align any residual live/in-play architecture assumptions with the prematch-only product scope.
2. **BOOKMAKER INTEGRATION ENGINEER -> #15** may proceed in parallel to establish a second permitted prematch source and representative fixtures.
